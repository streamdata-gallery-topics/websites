...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/websites/master/_listings/dezrez/apis.md
...
- name: Dezrez.Rezi.Client.Api - Get files and details that can be used to customize
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/websites/master/_listings/dezrez/apibrandingwebsitesetupbrandid-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/websites/master/_listings/dezrez/apibrandingwebsitesetupbrandid-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Get files and details that can be used to customize
    a website
  x-api-slug: apibrandingwebsitesetupbrandid-get
  description: Get files and details that can be used to customize a website.
